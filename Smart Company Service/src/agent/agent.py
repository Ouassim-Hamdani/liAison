...
from agent.tools import load_company_data, get_employee_data, rag_call, send_official_claim, list_employees
...
class CustomerSupportAgent:
    def __init__(self, model="gpt-4.1", max_steps=10):
        ...
        self.tools = [load_company_data, get_employee_data, rag_call, send_official_claim, list_employees, PythonInterpreterTool(), FinalAnswerTool()]
